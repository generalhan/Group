                        ...
                        <div class="am-u-sm-12 am-u-md-9">
                            <form class="am-form am-form-horizontal">
                                ...
                                <div class="am-form-group">
                                 ...
                                 <div class="am-form-group">
                                    <label for="funcIndex" class="am-u-sm-3 am-form-label">函索引号 / Index</label>
                                    <div class="am-u-sm-9">
                                        <input type="text" id="funcIndex" name="funcIndex" placeholder="函索引号 / Index">
                                    </div>
                                </div>
	...
	<script type="text/javascript">
	 $(".am-btn-algo").click(function(){
		/*  $("form:first").submit(); */
		  var options = {   
		            type: 'POST',  
		            url: '${pageContext.request.contextPath}/algorithms/AddAlgorithms',  
	 ...
	 function showResponse(responseText, statusText, xhr, $form){      
	     if(responseText.code == "1"){  
	         ...
	         */  
	         alert("添加成功!"); 
	         location.reload(); 
	      /*  $('body').load("http://111.230.246.33:8080/Restaurant/type/listTotal").fadeIn('fast');  */
