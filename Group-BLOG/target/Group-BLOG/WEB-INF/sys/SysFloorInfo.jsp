            ...
            <ul class="am-nav am-nav-pills am-topbar-nav am-topbar-right admin-header-list tpl-header-list">
                ...
                <li class="am-dropdown" data-am-dropdown data-am-dropdown-toggle>
                    ...
                    <ul class="am-dropdown-content">
                        <li><a href="<%=request.getContextPath()%>/tuser/logout"><span class="am-icon-power-off"></span> 退出</a></li>
                    </ul>
                </li>
                                ...
                                <table class="am-table am-table-striped am-table-hover table-main">
                                    ...
                                    <c:forEach var="admin" items="${requestScope.TotalList}" varStatus="i">
                                        <tr>
                                            ...
                                            <td class="am-hide-sm-only">${admin.replyedName}</td>
                                ...
                                <div class="am-cf">
                                    ...
                                    <div class="am-fr">
                                        ...
                                        <c:if test="${page.hasPrePage}">
												<li>	<a href="${pageContext.request.contextPath}/tadmin/showFloorInfoView/${1}" >首页</a></li>
												<li>	<a href="${pageContext.request.contextPath}/tadmin/showFloorInfoView/${page.currentPage -1}" >上一页</a></li>
												</c:if>
												<c:if test="!${page.hasPrePage}">												
												<li>	首页</li>
												<li>	上一页</li>
												...
												<li>	<a href="${pageContext.request.contextPath}/tadmin/showFloorInfoView/${page.currentPage + 1}" >下一页</a></li>
												<li>	<a href="${pageContext.request.contextPath}/tadmin/showFloorInfoView/${page.totalPage}" >尾页</a>		</li>	
												</c:if>
												<c:if test="!${page.hasNextPage}">
												<li>	下一页</li>
													<li>尾页</li>
                ...
                "buttons":{
                    "确定":function () {        	 
                        ...
                        $.ajax({
             	   			cache: false,
             	   			type: "POST",
             	   			url: '<%=request.getContextPath()%>/tadmin/removeFloorInfo',  
             	   			data: {
             	   				"pkId" : pkId
             	   			},
             	   			 dataType:"json",
