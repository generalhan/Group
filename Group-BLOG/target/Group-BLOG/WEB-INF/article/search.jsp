		...
		var recordCount='${recordCount}';
		 var content=
			 ...
			 $.ajax({
					cache: false,
					type: "POST",
					url: '${pageContext.request.contextPath}/tbloginfo/search ',  
					 dataType:"json",
					 data: {
			   				"key" : key,
					...
					success: function(data) {
						 $.each(data,function (index,e){
							 ...
							 $(".table-hover tr:last td a").attr("href","${pageContext.request.contextPath}/tcommentinfo/showEsSearch/"+e.item);
