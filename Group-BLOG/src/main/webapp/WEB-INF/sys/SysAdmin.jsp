                                    ...
                                    <c:forEach var="admin" items="${requestScope.TotalList}" varStatus="i">
                                        <tr>
                                         ...
                                         <td class="am-hide-sm-only">******</td>
                                          <c:choose>
   <c:when test="${admin.userState eq '0'}"> 
      ...
      <td class="am-hide-sm-only">拉黑</td>
                                         ...
                                         <td class="am-hide-sm-only"><fmt:formatDate value="${admin.gmtCreate }" pattern="yyyy-MM-dd" /></td>
                                            <td>
                                                <div class="am-btn-toolbar">
                                                    <div class="am-btn-group am-btn-group-xs">                                      
                                                <button class="am-btn am-btn-default am-btn-xs am-text-secondary" data-toggle="modal" data-target="#editModal" onclick="edit(${admin.pkId},'${admin.userName}','${admin.userRealName}','${admin.userPersonality}');return false;"><span class="am-icon-pencil-square-o"></span> 编辑</button>                                          
                                                      <button class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only" data-toggle="modal" data-target="#myModal" onclick="defriend(${admin.pkId},'${admin.userName}',${admin.userState});return false;"><span class="am-icon-plus"></span> 拉黑</button>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
                                ...
                                <div class="am-cf">
                                    ...
                                    <div class="am-fr">
                                        ...
                                        <c:if test="${page.hasPrePage}">
												<li>	<a href="${pageContext.request.contextPath}/tuser/showUserView/${1}" >首页</a></li>
												<li>	<a href="${pageContext.request.contextPath}/tuser/showUserView/${page.currentPage -1}" >上一页</a></li>
												</c:if>
												<c:if test="!${page.hasPrePage}">												
												<li>	首页</li>
												<li>	上一页</li>
												...
												<li>	<a href="${pageContext.request.contextPath}/tuser/showUserView/${page.currentPage + 1}" >下一页</a></li>
												<li>	<a href="${pageContext.request.contextPath}/tuser/showUserView/${page.totalPage}" >尾页</a>		</li>	
												</c:if>
												<c:if test="!${page.hasNextPage}">
												<li>	下一页</li>
													<li>尾页</li>
...
<tr>
 <th>拉黑状态(可修改)</th>
<td><input name="userState" type="radio" value="1">拉黑</td>
 <td><input name="userState" type="radio" value="0">正常</td>
</tr>
</table>
            </div>
...
<tr>
 <th>用户姓名(不可修改)</th>
 <td><input name="userName" readonly="readonly" style="border:double #009" id="euserName"></td>
</tr>
<tr>
 <th>个性签名(可修改)</th>
 <td><input name="userPersonality"  style="border:double #009" id="userPersonality" autofocus="autofocus"></td>
</tr>
<tr>
 <th>用户大名(可修改)</th>
 <td><input name="userRealName" style="border:double #009" id="userRealName"></td>
                ...
                "buttons":{
                    "确定":function () {        	 
                        ...
                        $.ajax({
             	   			cache: false,
             	   			type: "POST",
             	   			url: '<%=request.getContextPath()%>/tadmin/remove',  
             	   			data: {
             	   				"pkId" : pkId
             	   			},
             	   			 dataType:"json",
    ...
    <script type="text/javascript"> 
    function defriend(e,f,g){
    	$("#pkId").val(e);
        $("#userName").val(f);
        /**根据值设置radio选中**/
        $(":radio[name='userState'][value='" + g + "']").prop("checked", "checked");
    }
    
    function edit(e,f,g,h){
    	$("#epkId").val(e);
        $("#euserName").val(f);
        $("#userPersonality").val(h);
        $("#userRealName").val(g);
    }
    ...
    function changeDefriend(){
    	...
    	var pkId=$("#pkId").val();
    	 $.ajax({
	   			cache: false,
	   			type: "POST",
	   			url: '<%=request.getContextPath()%>/tadmin/defriend',  
	   			data: {
	   				"pkId" : pkId,
	   				"userState" : userState
	   			},
   ...
   function  changeUserInfo(){
   	...
   	var pkId=$("#epkId").val();
   	 $.ajax({
	   			cache: false,
	   			type: "POST",
	   			url: '<%=request.getContextPath()%>/tadmin/edit',  
	   			data: {
	   				"pkId" : pkId,
