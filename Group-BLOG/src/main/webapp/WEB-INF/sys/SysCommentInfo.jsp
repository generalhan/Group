                                ...
                                <div class="am-cf">
                                    ...
                                    <div class="am-fr">
                                        ...
                                        <c:if test="${page.hasPrePage}">
												<li>	<a href="${pageContext.request.contextPath}/tadmin/showCommentInfoView/${1}" >首页</a></li>
												<li>	<a href="${pageContext.request.contextPath}/tadmin/showCommentInfoView/${page.currentPage -1}" >上一页</a></li>
												</c:if>
												<c:if test="!${page.hasPrePage}">												
												<li>	首页</li>
												<li>	上一页</li>
												...
												<li>	<a href="${pageContext.request.contextPath}/tadmin/showCommentInfoView/${page.currentPage + 1}" >下一页</a></li>
												<li>	<a href="${pageContext.request.contextPath}/tadmin/showCommentInfoView/${page.totalPage}" >尾页</a>		</li>	
												</c:if>
												<c:if test="!${page.hasNextPage}">
												<li>	下一页</li>
													<li>尾页</li>
                ...
                "buttons":{
                    "确定":function () {        	 
                        ...
                        $.ajax({
             	   			cache: false,
             	   			type: "POST",
             	   			url: '<%=request.getContextPath()%>/tadmin/removeCommentInfo',  
             	   			data: {
             	   				"pkId" : pkId
             	   			},
             	   			 dataType:"json",
