...
<body data-type="generalComponents">
                        ...
                        <div class="tpl-form-body tpl-form-line">
                            <div class="am-form tpl-form-line-form">
                                <div class="am-form-group">
                                    <label for="user-name" class="am-u-sm-3 am-form-label">算法类型 <span class="tpl-form-line-small-title"></span></label>
                                    <div class="am-u-sm-9">
                                        <input type="text" class="tpl-form-input" id="algotithmsType"  placeholder="请输入算法类型">
                                        <small>请填写算法类型。</small>
                                    </div>
                                </div>
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="text" id="gmtCreate" class="am-form-field tpl-form-no-bg" placeholder="发布时间" data-am-datepicker="" readonly/>
   ...
   <script src="<%=request.getContextPath()%>/Static/js/jquery.form.js" type="text/javascript"></script>
    ...
    $(".am-btn-algotype").click(function(){
    	var algotithmsType=$("#algotithmsType").val();
    	if(!algotithmsType){
    		alert("算法类型不能为空!");
    		clean();
    	}
    		 ...
    		 $.ajax({
 	   			cache: false,
 	   			type: "POST",
 	   			url: '<%=request.getContextPath()%>/algorithmsType/add',  
 	   			data: "algotithmsType="+algotithmsType+"&gmtCreate="+$("#gmtCreate").val(),
 	   			 dataType:"json",
 	   			 async: false,
