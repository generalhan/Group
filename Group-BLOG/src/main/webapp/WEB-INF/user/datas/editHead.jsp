...
<div class="tpl-block">
                    ...
                    <div class="am-g">
                        <form class="tpl-form-body tpl-form-line" action="" enctype="multipart/form-data" method="post" id="forms">
                                 ...
                                 <div class="am-form-group">
                                    <label for="user-weibo" class="am-u-sm-3 am-form-label">个人 <span class="tpl-form-line-small-title">图片</span></label>
                                    <div class="am-u-sm-9">
    ...
    <i class="am-icon-cloud-upload"></i> 修改头像</button>
                                ...
                                <div class="am-form-group">
                                    <label for="user-name" class="am-u-sm-3 am-form-label">个性签名 <span class="tpl-form-line-small-title"></span></label>
                                    <div class="am-u-sm-9">
                          ...
                          <div class="am-form-group" hidden="hidden">
                                    <label for="user-name" class="am-u-sm-3 am-form-label">真实姓名 <span class="tpl-form-line-small-title"></span></label>
                                    <div class="am-u-sm-9">
                                        <input type="text" name="pkId" class="tpl-form-input" id="pkId" value="${currentUser.pkId }" hidden="hidden"/>
