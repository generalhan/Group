...
<%-- <shiro:hasRole name="user">您拥有普通用户的所有操作权限<br/></shiro:hasRole>  --%>  
  <%-- <shiro:hasRole name="admin">同时拥有角色admin <br/></shiro:hasRole>  --%>  
				...
				<TR>
					...
					<TD COLSPAN="2" align="center" valign="top">
						<table width="100%" style="BORDER-RIGHT:#cccccc 1px solid; BORDER-TOP:#cccccc 1px solid; BORDER-LEFT:#cccccc 1px solid; BORDER-BOTTOM:#cccccc 1px solid; BACKGROUND-COLOR:#f5f5f5"
							...
							<tr height="30">
								<td background="${pageContext.request.contextPath}/Static/img/l-bg3.jpg">&nbsp;&nbsp;&nbsp;<font color="#cccccc"><b>发表文章</b></font></td>
							</tr>
												<c:choose>
			<c:when test="${!empty currentUser }">
							<tr height="20">
								<td>
									&nbsp;&nbsp;&nbsp;标题：
									<div>
										&nbsp;&nbsp;&nbsp;<input type="text" name="blogTitle"  Width="600px" Style="inputcss" autofocus="autofocus"/>
									</div>
								</td>
							</tr>
							<tr height="20">
...
$(".am-btn-save").click(function(){
	...
	$.ajax({
			cache: false,
			type: "POST",
			url: '${pageContext.request.contextPath}/tbloginfo/save',  
			data: {
			...
			success: function(data) {
				if(data.code == 1){location.href="${pageContext.request.contextPath}/tbloginfo/showAllBlogView/1"; }
				else{alert("添加失败!");}
